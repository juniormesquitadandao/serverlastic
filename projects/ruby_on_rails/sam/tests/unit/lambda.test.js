...
describe('Lambda', () => {
  it('must return html', async () => {
    ...
    const html = fs.readFileSync('/tmp/serverlastic/public/samples/index.html');
  ...
  it('must return css', async () => {
    ...
    const css = fs.readFileSync('/tmp/serverlastic/public/samples/style.css');
  ...
  it('must return js', async () => {
    ...
    const js = fs.readFileSync('/tmp/serverlastic/public/samples/script.js');
  ...
  it('must return json', async () => {
    ...
    const json = fs.readFileSync('/tmp/serverlastic/public/samples/data.json');
  ...
  it('must return csv', async () => {
    ...
    const csv = fs.readFileSync('/tmp/serverlastic/public/samples/data.csv');
